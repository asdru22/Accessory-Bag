...
execute unless data storage acbag:storage root.temp.cauldron.tempItem{id:"minecraft:wooden_shovel"} unless data storage acbag:storage root.temp.cauldron.tempItem{id:"minecraft:glass_bottle"} unless data storage acbag:storage root.temp.cauldron.tempItem{id:"minecraft:water_bucket"} run function acbag:block/soul_cauldron/color_blending
