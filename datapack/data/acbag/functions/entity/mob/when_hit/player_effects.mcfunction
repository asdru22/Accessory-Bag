...
#
execute if score .concussive_glove acbag.dummy matches 1 if data entity @s HandItems[0].id run function acbag:entity/player/on_hit/acc/concussive_glove/effect
